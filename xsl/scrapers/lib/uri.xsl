...
<p>$Id: uri.xsl 544 2004-12-04 05:15:20Z deusx $</p>
...
<xsl:template name="uri:expand" mode="none">
...
<xsl:template name="uri:split-scheme" mode="none">
...
<xsl:template name="uri:split-authority" mode="none">
...
<xsl:template name="uri:follow-path" mode="none">
...
<xsl:template name="uri:path-parent" mode="none">
  <xsl:param name="path"/>
